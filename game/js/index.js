...
(function($, window, undefined){
  ...
  Hangman = {
    ...
    win: function(){
      ...
      // this is messy
      this.msgText.html("Now you are going to experience 3D Space :p");
      this.showMsg();
    ...
    lose: function(){
      ...
      this.msgText.html("Don't worry, TRY AGAIN by reloading the page, or proceed to the 3D Space :p ");
      this.showMsg();
    }
